...
def afficher():
    ...
    visualiser.add_button("expansion", "Expansion",True)
    ...
    while running and not stop_event.is_set():
        ...
        computation.expansion(ratio_threshold=1.3)
        visualiser.clear()
        visualiser.draw_expansion_triangles(computation,"expansion")
        visualiser.draw_central_triangles(computation,"triangles_v")
        visualiser.draw_zones(computation,"zones")
        ...
        visualiser.draw_areas(computation,"areas")
