...
class Button:
    def __init__(self, rect, text, font, on_color, off_color,active, text_color=(255, 255, 255)):
        ...
        self.active = active  # État ON/OFF
...
class Parametres():
    ...
    def add_button(self, label,text,width, active):
        ...
        button = Button(
            ...
            on_color=(0, 255, 0),
            off_color=(255, 0, 0),
            active=active,  # État initial OFF
        )
        self.buttons[label] = button
    def draw_params(self, screen,width, height):
